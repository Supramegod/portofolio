...
export const Footer = () => {
  ...
  return (
    <footer className="border-t border-[#5E00FF]/40 bg-[#000000] py-4 font-sans text-[#F8F9FA]">
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-center px-6 lg:px-8">
        <div className="mb-4 flex w-full max-w-7xl flex-col items-center justify-center sm:flex-row sm:justify-between sm:space-y-0">
          <div className="mb-4 text-xl font-extrabold tracking-wider text-[#B388FF]/70 transition duration-300 sm:mb-0 sm:text-2xl">
            Jalu Pradipta
          </div>
        ...
        <p className="mt-4 text-center text-xs text-[#6A1B9A]/70 sm:mt-2">
